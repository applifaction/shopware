...
class RecalculationService
{
    ...
    {
        $delivery = $cart->getDeliveries()->firstWhere(function (Delivery $delivery) use ($cart) {
            return $delivery->getExtensionOfType(OrderConverter::ORIGINAL_ID, IdStruct::class)?->getId() === $cart->getExtensionOfType(OrderConverter::ORIGINAL_PRIMARY_ORDER_DELIVERY, IdStruct::class)?->getId();
        });
